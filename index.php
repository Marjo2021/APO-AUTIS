            ...
            <div class="contenedor-form">
                ...
                <form action="validaradmin.php" method="POST"  class="formulario active">
                    ...
                    <div class="grupo-input">
                        ...
                        <input type="Contrasena" placeholder="Ingresa tu Contraseña" name="Contrasena" required onblur="quitarespacios(this);"  onkeyup="sinespacio(this);"  minlength="8" maxlength="30" class="input-text clave" required />
